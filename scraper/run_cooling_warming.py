"""Run only the cooling and warming centers scraper."""
import asyncio
...
async def run_cooling_warming_scraper():
    """Run cooling and warming centers scraper only."""
    print("\n" + "=" * 60)
    print("Hope Platform - Cooling & Warming Centers Scraper")
    print(f"Started at: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("=" * 60)

    scraper = NYCCoolingWarmingScraper()
    geocoder = Geocoder()
    ...
    print("\n" + "=" * 60)
    print("Cooling & Warming Centers Scraping Complete")
    print("=" * 60)
...
if __name__ == "__main__":
    asyncio.run(run_cooling_warming_scraper())
